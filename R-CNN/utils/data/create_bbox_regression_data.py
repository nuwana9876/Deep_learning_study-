...
if __name__ == '__main__':
    ...
    for sample_name in samples:
        # Extract positive sample boundary box coordinates（IoU>=0.5）
        ...
        positive_list = list()
        # we use region proposals as train data by using selective search algorithm
        # if ioU is more than 0.6, that samples define positive sample
        ...
        # If a positive sample boundary box exists（IoU>0.6), Then save the corresponding image and dimension boundary boxes.，
        if len(positive_list) > 0:
            ...
            print('-------- {} fall short of the requirements'.format(sample_name))
